      ...
      <div class="mb-16 grid gap-4 md:grid-cols-3 md:gap-x-16">
        <div>
          <div class="flex">
            ...
            &nbsp;
            <h4 class="my-auto text-sm text-gray-400">v2.15.8</h4>
          </div>
          <p>© 2022 - Nuxt Project</p>
          <p class="text-gray-400">released under MIT license</p>
        </div>
        <div>
          <div class="flex">
            <h3 class="text-lg font-semibold">Vue.js</h3>
            &nbsp;
            <h4 class="my-auto text-sm text-gray-400">v2.6.14</h4>
          </div>
